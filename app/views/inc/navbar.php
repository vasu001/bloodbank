            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarlist">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/#home" class="nav-link"><i
                                        class="fas fa-home"></i>
                                Home</a>
                        </li>
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/#about-head-section" class="nav-link"><i
                        ...
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/pages/bloodsamples" class="nav-link"><i
                                ...
                                Samples</a></li>
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/#contact-head-section" class="nav-link"><i
